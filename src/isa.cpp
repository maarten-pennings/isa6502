...
int isa_addrmode_find(const char * aname) {
  ...
  while( lo<=hi ) {
    int mid= (lo+hi)/2;
    int cmp= strcmp_P(aname,isa_addrmode_aname(mid));
    if( cmp==0 ) return mid;
...
const char ISA_IIX_ASL_desc  [] /* 3*/ PROGMEM = "Shift Left One Bit (Memory or Accumulator)";
...
const char ISA_IIX_CLD_desc  [] /*15*/ PROGMEM = "Clear Decimal Mode";
...
const char ISA_IIX_CLI_desc  [] /*16*/ PROGMEM = "Clear Interrupt Disable Bit";
...
const char ISA_IIX_EOR_desc  [] /*24*/ PROGMEM = "Exclusive-or Memory with Accumulator";
...
const char ISA_IIX_LSR_desc  [] /*33*/ PROGMEM = "Shift One Bit Right (Memory or Accumulator)";
...
const char ISA_IIX_PHP_desc  [] /*37*/ PROGMEM = "Push Processor Status on Stack";
...
const char ISA_IIX_PLP_desc  [] /*39*/ PROGMEM = "Pull Processor Status from Stack";
...
const char ISA_IIX_SED_desc  [] /*46*/ PROGMEM = "Set Decimal Mode";
...
const char ISA_IIX_SEI_desc  [] /*47*/ PROGMEM = "Set Interrupt Disable Status";
...
const char ISA_IIX_STY_desc  [] /*50*/ PROGMEM = "Sore Index Y in Memory";
...
int isa_instruction_find(const char * iname) {
  ...
  while( lo<=hi ) {
    int mid= (lo+hi)/2;
    int cmp= strcmp_P(iname,isa_instruction_iname(mid));
    if( cmp==0 ) return mid;
    if( cmp>0 ) lo=mid+1; else hi=mid-1;
  }
