...
// Use these pointers with xxx_P() functions, the f() macro, or the %S print format (capital S!)
...
#define ISA_AIX_ZIX    9 // OPC (LL,X)
#define ISA_AIX_ZIY   10 // OPC (LL),Y
#define ISA_AIX_ZPG   11 // OPC *LL
#define ISA_AIX_ZPX   12 // OPC *LL,X
#define ISA_AIX_ZPY   13 // OPC *LL,Y
