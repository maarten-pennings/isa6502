...
#define ISA_AIX_REL    8 
#define ISA_AIX_ZIX    9 
#define ISA_AIX_ZIY   10 
...
void         isa_unparse(char*buf,const char*fmt,char*op);// fmt is a isa_addrmode_syntax(), and op an actual operand; prints to buf
